...
export default function ScrollExpandMedia({
  ...
  useEffect(() => {
    ...
    window.addEventListener('resetSection', handleResetSection)
    return () => window.removeEventListener('resetSection', handleResetSection)
  }, [])
            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <p className="text-xl text-white" style={{ transform: `translateX(-${textTranslateX}vw)` }}>
                      {date}
                    </p>
                  )}
                  {scrollToExpand && (
              ...
              >
                {subtitle ? (
                  <>
                    ...
                    <motion.p
                      className="text-sm md:text-lg lg:text-xl font-medium text-center text-white transition-none max-w-5xl"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {subtitle}
                    </motion.p>
